<div style="padding-bottom: 10px"></div>
     ...
     <div class="container">  
            ...
            <div class="col">
            <div class="logo">
              <a   href="<?php echo base_url() ?>"><img src="<?php echo base_url() ?>assets/img/imagi.jpg"  width="50px""></a>
            </div>
            </div>
            <div class="logo">
            <div class="col-auto">
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item dropdown">
                      <a class="nav-link dropdown-toggle" href="<?php echo base_url() ?>profile"" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Profile
                      </a>
